...
in the src folder you need to create a new `config.js` file that contains the following
```
const apiKey = 'your youTube API key';
export default apiKey;
```

to create a YouTube web API key please visit: https://console.developers.google.com
